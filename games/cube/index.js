$(document).ready(function () {
    ...
    function addsf() {
        ...
        for (i = 1; i <= 6; i++)
            for (j = 1; j <= 9; j++) {
                ...
                cube_html += '<li id="sf' + i + '_' + j + '" style="background-color:' + subface[i][j][1] + '; transform:' + subface[i][j][2] + ' translateZ(150px); -moz-transform:' + subface[i][j][2] + ' translateZ(150px);"></li>'
    ...
    //转动整体
    function rotateCUBE() {
        $("#cube").css("transform", "rotateX(" + roX + "deg) rotateY(" + roY + "deg) translateX(" + trZ * Math.sin(-roX * 0.0174) + "px) translateY(" + trZ * Math.sin(roY * 0.0174) + "px) translateZ(-" + trZ + "px)");
    ...
    function lru(x) {
        if (!r_switch) {
            ...
            if (x > 0) {
                $("#topF").css("transform", "rotateY(-90deg)");
                $("#topF").css("-moz-transform", "rotateY(-90deg)");
                col_c2(5);
                for (j = 1; j <= 3; j++) {
                    $("#sf1_" + j).css("transform", subface[4][j][2] + " translateZ(150px)");
                    $("#sf2_" + j).css("transform", subface[3][j][2] + " translateZ(150px)");
                    $("#sf3_" + j).css("transform", subface[1][j][2] + " translateZ(150px)");
                    $("#sf4_" + j).css("transform", subface[2][j][2].replace("Y(180", "Y(-180") + " translateZ(150px)");
                ...
                col_c(5);
                for (j = 1; j <= 3; j++) {
                    $("#sf1_" + j).css("transform", subface[3][j][2] + " translateZ(150px)");
                    $("#sf2_" + j).css("transform", subface[4][j][2].replace("Y(-90", "Y(270") + " translateZ(150px)");
                    $("#sf3_" + j).css("transform", subface[2][j][2] + " translateZ(150px)");
                    $("#sf4_" + j).css("transform", subface[1][j][2] + " translateZ(150px)");
    ...
    function lrb(x) {
        if (!r_switch) {
            ...
            var timer_ = setTimeout(function () { r_switch = 0 }, 500);
            if (x > 0) {
                $("#bottomF").css("transform", "rotateY(-90deg)");
    ...
    function bul(x) {
        if (!r_switch) {
            ...
            var timer_ = setTimeout(function () { r_switch = 0 }, 500);
            if (x > 0) {
                $("#leftF").css("transform", "rotateX(90deg) translateY(-50px) translateZ(-50px)");
                $("#leftF").css("-moz-transform", "rotateX(90deg) translateY(-50px) translateZ(-50px)");
                col_c(4);
                for (j = 1; j <= 7; j += 3) {
                    $("#sf1_" + j).css("transform", subface[5][j][2] + " translateZ(150px)");
                    $("#sf2_" + (10 - j)).css("transform", subface[2][10 - j][2].replace("deg)", "deg) rotateX(270deg)") + " translateZ(150px)");
                    $("#sf5_" + j).css("transform", subface[5][j][2].replace("X(90", "X(180") + " translateZ(150px)");
                    $("#sf6_" + j).css("transform", subface[1][j][2] + " translateZ(150px)");
                ...
                col_c2(4);
                for (j = 1; j <= 7; j += 3) {
                    $("#sf1_" + j).css("transform", subface[6][j][2] + " translateZ(150px)");
                    $("#sf2_" + (10 - j)).css("transform", subface[2][10 - j][2].replace("deg)", "deg) rotateX(90deg)") + " translateZ(150px)");
                    $("#sf5_" + j).css("transform", subface[1][j][2] + " translateZ(150px)");
                    $("#sf6_" + j).css("transform", subface[6][j][2].replace("X(-90", "X(-180") + " translateZ(150px)");
    ...
    function bur(x) {
        if (!r_switch) {
            ...
            var timer_ = setTimeout(function () { r_switch = 0 }, 500);
            if (x > 0) {
                $("#rightF").css("transform", "rotateX(90deg) translateY(-50px) translateZ(-50px)");
    ...
    function buf(x) {
        if (!r_switch) {
            ...
            var timer_ = setTimeout(function () { r_switch = 0 }, 500);
            if (x > 0) {
                $("#frontF").css("transform", "rotateZ(90deg) translateX(50px) translateY(-50px)");
                $("#frontF").css("-moz-transform", "rotateZ(90deg) translateX(50px) translateY(-50px)");
                col_c2(1);
                for (j = 1; j <= 3; j++) {
                    $("#sf5_" + (j + 6)).css("transform", subface[5][j + 6][2].replace("deg)", "deg) rotateY(90deg)") + " translateZ(150px)");
                    $("#sf6_" + j).css("transform", subface[6][j][2].replace("deg)", "deg) rotateY(-90deg)") + " translateZ(150px)");
                    $("#sf3_" + (j * 3 - 2)).css("transform", subface[3][j * 3 - 2][2].replace("deg)", "deg) rotateX(-90deg)") + " translateZ(150px)");
                    $("#sf4_" + (j * 3)).css("transform", subface[4][j * 3][2].replace("deg)", "deg) rotateX(90deg)") + " translateZ(150px)");
    ...
    function bufm(x) {
        if (!r_switch) {
            ...
            if (x > 0)
                for (j = 1; j <= 3; j++) {
                    $("#sf5_" + (j + 3)).css("transform", subface[5][j + 3][2].replace("deg)", "deg) rotateY(90deg)") + " translateZ(150px)");
                    $("#sf6_" + (j + 3)).css("transform", subface[6][j + 3][2].replace("deg)", "deg) rotateY(-90deg)") + " translateZ(150px)");
                    $("#sf3_" + (j * 3 - 1)).css("transform", subface[3][j * 3 - 1][2].replace("deg)", "deg) rotateX(-90deg)") + " translateZ(150px)");
                    $("#sf4_" + (j * 3 - 1)).css("transform", subface[4][j * 3 - 1][2].replace("deg)", "deg) rotateX(90deg)") + " translateZ(150px)");
    ...
    function bub(x) {
        if (!r_switch) {
            ...
            var timer_ = setTimeout(function () { r_switch = 0 }, 500);
            if (x > 0) {
                $("#backF").css("transform", "rotateZ(90deg) translateX(50px) translateY(-50px)");
                $("#backF").css("-moz-transform", "rotateZ(90deg) translateX(50px) translateY(-50px)");
                col_c(2);
                for (j = 1; j <= 3; j++) {
                    $("#sf5_" + j).css("transform", subface[5][j][2].replace("deg)", "deg) rotateY(90deg)") + " translateZ(150px)");
                    $("#sf6_" + (j + 6)).css("transform", subface[6][j + 6][2].replace("deg)", "deg) rotateY(-90deg)") + " translateZ(150px)");
                    $("#sf3_" + (j * 3)).css("transform", subface[3][j * 3][2].replace("deg)", "deg) rotateX(-90deg)") + " translateZ(150px)");
                    $("#sf4_" + (j * 3 - 2)).css("transform", subface[4][j * 3 - 2][2].replace("deg)", "deg) rotateX(90deg)") + " translateZ(150px)");
